/*
 * @brief I2C bus slave example using polling mode
 *
 * @note
...
/** @defgroup I2CS_POLLING_5410X I2C slave (polling) ROM API example
 * @ingroup EXAMPLES_ROM_5410X
 * @include "rom\i2cs_polling\readme.txt"
 */
...
int main(void)
{
	...
	while (1) {
		...
		/* Setup transfer response for the master */
		...
		while (sXfer.status == ERR_I2C_BUSY) {
